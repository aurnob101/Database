		...
		<section class="gallery-section2">
			<div class="container">
				<div id="filters" class="button-group">
					<!-- <button class="button" data-filter="*">cse</button>
  					<button class="button" data-filter=".business">eee</button>
  					<button class="button" data-filter=".design">physics</button>
  					<button class="button" data-filter=".development">chemistry</button>
  					<button class="button" data-filter=".seo">math</button>
