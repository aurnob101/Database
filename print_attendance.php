...
<div class="course-details">
  ...
  <table class="course-details-table">
   ...
   while($row2=mysqli_fetch_assoc($result2)){
    ...
    $sql_query4 = "SELECT * FROM `attendance` WHERE student_id='$st_id' AND course_code='$course_code' AND status='P'";
...
<?php
	echo '</td>
				<td><a href="pdf_generate.php?course_code=';
				echo  $course_code;
			   echo'&t_name=';
				echo  $t_name;
				 echo '"><div style="text-align: center;">
				 <button class="view-button">Print Attendance Sheet</button>
			   </div>
			   </a></td>
			</tr>';
			?>
